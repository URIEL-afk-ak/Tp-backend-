package com.back.tpi.facturacion.facturacion.config;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Facturación - OPERADOR y ADMIN
                .requestMatchers("/api/facturas/**").hasAnyRole("OPERADOR", "ADMIN")
                
                // Estimación de tarifas - Todos los roles autenticados
                .requestMatchers("/api/tarifas/**").authenticated()
