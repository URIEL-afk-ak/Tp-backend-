    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // POST /contenedores - CLIENTE o OPERADOR pueden crear
                .requestMatchers("/api/contenedores").hasAnyRole("CLIENTE", "OPERADOR", "ADMIN")
                
                // GET /contenedores - Solo OPERADOR y ADMIN
                .requestMatchers("/api/contenedores/pendientes").hasAnyRole("OPERADOR", "ADMIN")
                
                // GET /contenedores/{id} - CLIENTE (dueño), OPERADOR, ADMIN
                .requestMatchers("/api/contenedores/{id}").hasAnyRole("CLIENTE", "OPERADOR", "ADMIN")
                
                // PATCH /contenedores/{id}/estado - Solo OPERADOR y ADMIN
                .requestMatchers("/api/contenedores/{id}/estado").hasAnyRole("OPERADOR", "ADMIN")
