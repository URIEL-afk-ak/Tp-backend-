    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Asignar ruta - Solo OPERADOR y ADMIN
                .requestMatchers("/api/rutas/asignar").hasAnyRole("OPERADOR", "ADMIN")
                
                // Preview de ruta - Todos autenticados (para cálculo)
                .requestMatchers("/api/rutas/preview").authenticated()
                
                // Actualizar estado de tramo - TRANSPORTISTA, OPERADOR, ADMIN
                .requestMatchers("/api/tramos/{id}/estado").hasAnyRole("TRANSPORTISTA", "OPERADOR", "ADMIN")
                
                // Ver tramos asignados - TRANSPORTISTA (sus propios), OPERADOR, ADMIN
                .requestMatchers("/api/tramos/asignados").hasAnyRole("TRANSPORTISTA", "OPERADOR", "ADMIN")
                
                // Distancia - Todos autenticados
                .requestMatchers("/api/distancia").authenticated()
