package com.back.tpi.solicitudes.solicitudes.config;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Endpoints públicos (opcional, si hay alguno)
                // .requestMatchers("/api/public/**").permitAll()
                
                // Endpoints específicos por rol
                .requestMatchers("/api/solicitudes").hasRole("CLIENTE")
                .requestMatchers("/api/solicitudes/{id}").hasAnyRole("CLIENTE", "OPERADOR", "ADMIN")
                .requestMatchers("/api/solicitudes/{id}/estado").hasAnyRole("OPERADOR", "ADMIN")
                .requestMatchers("/api/solicitudes/estado/**").hasAnyRole("OPERADOR", "ADMIN")
                
                // Swagger/OpenAPI - permitir en desarrollo (comentar en producción)
