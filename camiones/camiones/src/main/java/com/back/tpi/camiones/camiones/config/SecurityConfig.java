package com.back.tpi.camiones.camiones.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // POST/PUT/DELETE - Solo OPERADOR y ADMIN
                .requestMatchers("/api/camiones").hasAnyRole("OPERADOR", "ADMIN")
                .requestMatchers("/api/transportistas").hasAnyRole("OPERADOR", "ADMIN")
                
                // GET - OPERADOR, ADMIN y TRANSPORTISTA pueden consultar
                .requestMatchers(HttpMethod.GET, "/api/camiones/**").hasAnyRole("OPERADOR", "ADMIN", "TRANSPORTISTA")
                .requestMatchers(HttpMethod.GET, "/api/transportistas/**").hasAnyRole("OPERADOR", "ADMIN", "TRANSPORTISTA")
     ...
     * Filtra roles por defecto y mapea como ROLE_* para Spring Security.
     */
    @Bean
